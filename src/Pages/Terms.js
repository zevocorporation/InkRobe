        ...
        return (
            <div id="Page">
                ...
                <ul>
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to InkRobe, 1st Floor, 95/302, West, Mudichur Road, Tambaram, Chennai - 600045.</li>
                    ...
                    <li><strong>Website</strong> refers to InkRobe, accessible from https://inkrobe.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
                ...
                <ul>
                    <li>By email: inkrobe@gmail.com</li>
                </ul>
            </div>
        )
    }
